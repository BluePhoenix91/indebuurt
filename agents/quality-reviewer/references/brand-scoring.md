...
This document defines how the Quality Reviewer calculates the Brand portion of the 0-100 quality score.

**Philosophy:** Score pages on brand consistency, authentic local voice, and natural prose. Focus on terminology, tone, and authenticity.

---

## Narrative Fields Definition

**IMPORTANT:** All checks apply ONLY to narrative text fields (same as SEO scoring).
...
### Honesty Check
Verify that trade-offs mentioned are genuine limitations, not faux-humble marketing ("De enige nadeel is dat je verwend wordt").
